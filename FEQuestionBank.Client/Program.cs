...
builder.Services.AddScoped<ICauHoiApiClient, CauHoiApiClient>();
builder.Services.AddScoped<IImportApiClient, ImportApiClient>();
builder.Services.AddScoped<IToolApiClient, ToolApiClient>();
